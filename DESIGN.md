...
- Do not recolor, stretch, rotate, outline, shadow, or animate the logo. One exception, scoped and approved on the Paper page `12 — Run screens · Polish v2`: while a selected simulation is queued or running and has no evidence yet, the run detail's right panel shows the mark centred at 56px, breathing in opacity on the status-pulse token and solid under reduced motion. Nothing else moves the mark, and nothing else may. (Developer decision, 2026-09-07.)
