...
- The account control stays at the bottom, in a 56px band — the organization bar's own height — under a hairline that spans the sidebar. The control draws no box of its own at rest; only the avatar square is boxed. (Read off Paper page `12`, 2026-09-15; the band by developer decision, 2026-09-15 evening.)
