...
- The account control stays at the bottom, boxed in a hairline like the organization control above it, in a 56px band — the organization bar's own height — under a hairline that spans the sidebar. (Read off Paper page `12`, 2026-09-15; band and box by developer decision, 2026-09-15 evening.)
