---
title: "Test a LiveKit Agent Without Sharing Your API Secret"
sidebarTitle: "LiveKit Token Endpoint"
description: "Keep your LiveKit API secret on your side and give egma one scoped room token for each simulation."
---
