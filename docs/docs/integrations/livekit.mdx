...
initialized Egma project. Complete [CLI sign-in](/skills-cli-sdks/cli/install#sign-in-and-initialize)
first.
...
[CLI guide](/skills-cli-sdks/cli/install#create-a-suite-and-a-test) to write a test and
...
[Set up monitoring](/docs/platform/monitoring/set-up-monitoring#livekit). Both hooks can stay in
