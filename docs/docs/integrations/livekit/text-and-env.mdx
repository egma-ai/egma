...
the [Python SDK](/skills-cli-sdks/sdks/livekit-python#a-simulation-testing) or
[JavaScript SDK](/skills-cli-sdks/sdks/livekit-javascript#a-simulation-testing) guide. In rooms whose names
