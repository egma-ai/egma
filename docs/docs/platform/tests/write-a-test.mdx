...
The [Egma skills](/skills-cli-sdks/skills/install) can help you do this from your coding agent.

## Choose a test suite

If this repository is new to Egma, follow the [CLI guide](/skills-cli-sdks/cli/install)
