...
<Tabs>
  <Tab title="UI">
    ...
    <video controls autoPlay loop muted playsInline preload="metadata" aria-label="Create a test suite" poster="/docs/assets/videos/create-test-suite-poster.jpg">
      <source src="/docs/assets/videos/create-test-suite.mp4" type="video/mp4" />
    </video>
  </Tab>
  <Tab title="CLI">
