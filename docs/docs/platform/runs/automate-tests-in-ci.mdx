...
Set up a [supported agent connection](/skills-cli-sdks/cli/install#connect-an-agent), create a suite, and
...
Use Node.js 22 or later and install the [CLI](/skills-cli-sdks/cli/install) in the job. Run this
...
[regrade the simulation](/docs/platform/graders/configure-graders#regrade-a-simulation) before
...
[regrading the existing simulation](/docs/platform/graders/configure-graders#regrade-a-simulation).
...
The [API reference](/api-reference/overview) documents the complete request and response
