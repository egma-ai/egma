...
<Tabs>
  <Tab title="UI">
    ...
    <Frame caption="Add an OpenAI provider key in organization settings.">
      <img src="/docs/assets/images/ui/provider-key.jpg" alt="Add an OpenAI provider key in organization settings." />
    </Frame>
  </Tab>
  <Tab title="API">
