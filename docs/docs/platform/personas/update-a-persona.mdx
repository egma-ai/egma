...
Use **Preview voice** for a short audio sample. Preview uses the same audio path
as a simulation, but it does not test interruptions. Start a full simulation to
test turn timing and overlapping speech.
