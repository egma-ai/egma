...
<Tabs>
  ...
  <Tab title="CLI">
    ...
    **Angry caller**, and **Spanish caller**. Add the name
    ...
    accent, emotion, speech rate, speech volume, background sound, and background
    level for your project. All tests
...
<Tabs>
  <Tab title="UI">
    ...
    4. Choose speech-to-text, text-to-speech, and language models. Then choose
       the language, voice, accent, emotion, speech rate, speech volume, and
       background sound that
       the selected providers support.
