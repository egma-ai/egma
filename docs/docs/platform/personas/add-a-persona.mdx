...
<Tabs>
  ...
  <Tab title="CLI">
    ...
    **Angry caller**, and **Spanish caller**. Add the name
    ...
    capabilities --help`, then use `egma persona use`, `create`, `clone`,
    `update`, or `preview`. `egma persona settings <Persona ID>` prints the
...
<Tabs>
  <Tab title="UI">
    ...
    4. Choose speech-to-text, text-to-speech, and language models. Then choose
       ...
       Preview is a short voice sample. Test interruption timing in a full
       simulation.
