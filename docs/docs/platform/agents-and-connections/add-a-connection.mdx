...
<Tabs>
  <Tab title="UI">
    ...
    This walkthrough shows the LiveKit voice connection form during initial setup. It stops before entering credentials or saving the connection.

    <video controls autoPlay loop muted playsInline preload="metadata" aria-label="Set up a LiveKit voice connection" poster="/docs/assets/videos/add-livekit-connection-poster.jpg">
      <source src="/docs/assets/videos/add-livekit-connection.mp4" type="video/mp4" />
    </video>
  </Tab>
  <Tab title="CLI">
