...
For Pipecat, you need your Pipecat Cloud agent name and a public API key, or the URL and auth headers of your own bot starter. Your bot also needs the Egma SDK configured for simulations. To test a bot on your computer, `egma agent dev` adds the connections for you.
