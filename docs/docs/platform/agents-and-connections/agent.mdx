...
An agent represents the voice agent you want to test or monitor in Egma. We currently support LiveKit, Pipecat, and Retell agents. Please reach out to us if you would like support for another platform.
