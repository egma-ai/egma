...
<Tabs>
  <Tab title="UI">
    ...
    <Frame caption="Select Monitor production in the agent setup wizard.">
      <img src="/docs/assets/images/ui/monitoring-setup.jpg" alt="Select Monitor production in the agent setup wizard." />
    </Frame>
  </Tab>
