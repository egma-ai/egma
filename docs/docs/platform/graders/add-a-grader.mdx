...
<Tabs>
  <Tab title="UI">
    ...
    <Frame caption="The grader library. These two graders are already active in this project.">
      <img src="/docs/assets/images/ui/grader-library.jpg" alt="The grader library. These two graders are already active in this project." />
    </Frame>
  </Tab>
  <Tab title="API">
