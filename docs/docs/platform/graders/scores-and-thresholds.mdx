...
[review the evidence source](/docs/platform/runs/start-and-follow-a-run#check-which-evidence-arrived)
...
[CI example](/docs/platform/runs/automate-tests-in-ci) requires every simulation to complete
