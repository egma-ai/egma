...
<Frame caption="Create a custom grader with instructions, pass and fail criteria, and scope.">
  <img src="/docs/assets/images/ui/custom-grader.jpg" alt="Create a custom grader with instructions, pass and fail criteria, and scope." />
</Frame>
...
citations before changing your threshold. See [Scores and thresholds](/docs/platform/graders/scores-and-thresholds).
