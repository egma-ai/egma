...
<img
  ...
  src="/docs/assets/images/testing-flow-light.jpg"
  alt="Test and persona interact with your voice agent, the system under test. Both feed into a simulation, which is assessed by a grader."
/>
<img
  className="hidden dark:block"
  src="/docs/assets/images/testing-flow-dark.jpg"
  alt="Test and persona interact with your voice agent, the system under test. Both feed into a simulation, which is assessed by a grader."
/>
