...
Run creation returns a results URL. Grading continues after the CLI command finishes. Use [Start a run](/docs/platform/runs/start-and-follow-a-run) to inspect its progress and result.
