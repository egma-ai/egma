---
title: "Test suites"
description: "Group tests that you want to review and run together."
---
...
Write the files using [test format 5](/guides/write-a-test), then run
...
[start a run](/guides/start-and-follow-a-run). This lets you use the same tests
...
Create separate suites when you need separate run boundaries. A run does not
