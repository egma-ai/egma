...
every grader selected for it must pass**. Missing grades, grading errors,
cancellation, execution failures, and timeouts fail the CI job. This is the
policy in the example, not an overall verdict assigned by Egma.
