...
These organization-wide operations require a browser session or an organization API key. Project API keys cannot read or manage the roster or invitations.
