...
sidebarTitle: "Agents"
description: "Register agents, attach Chat or Voice connections, and list or retrieve agents by id. Connections are always reached through their agent."
---

Agents are the identities Egma tests and monitors. Each carries one or more **connections** that tell Egma how to reach it. A connection type names the path; its modality is Chat or Voice. Registering a provider connection is retry-safe when that type has a stable provider id. Credentials you supply are sealed before storage; only a safe hint comes back.
...
<ParamField body="connection" type="object">
  ...
  <Expandable title="connection fields">
    <ParamField body="type" type="string" required>
      Connection type. One of `retell`, `phone`, or `livekit`.
    </ParamField>

    <ParamField body="modality" type="string" required>
      `chat` or `voice`. The current valid pairs are Retell/Chat, Phone/Voice, and LiveKit/Voice.
    </ParamField>
    ...
    <ParamField body="config" type="object" required>
      ...
      **Retell** — `{ "retellAgentId": "<retell_agent_id>" }`
    ...
    <ParamField body="credentials" type="object">
      ...
      **Phone** — no credentials. Egma uses the platform carrier.
...
<ResponseField name="connection" type="object">
  ...
  <Expandable title="connection fields">
    ...
    <ResponseField name="name" type="string">Display name.</ResponseField>
    <ResponseField name="type" type="string">Connection type: `retell`, `phone`, or `livekit`.</ResponseField>
...
### Example — register a phone connection for a voice agent
