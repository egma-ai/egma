...
<ResponseField name="agent_platform" type="string | null">
...
<ResponseField name="access_variant" type="string">
...
<ResponseField name="simulations" type="object[]">
  ...
  <Expandable title="simulation fields">
    ...
    <ResponseField name="persona_version_id" type="string">The exact persona version used. This pins the persona instructions and its model selections for the simulation.</ResponseField>
