...
The simulator claims each simulation, conducts the conversation, and the grader writes one verdict per expected behavior after each simulation ends. The wizard follows the run live:
...
passed 1  ·  failed 0  ·  errored 0  ·  waiting 11
```
