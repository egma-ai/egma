...
The CLI asks for your Retell API key (or LiveKit credentials) and then asks how Egma should reach the agent. For Retell, the provider agent decides the compatible path:
