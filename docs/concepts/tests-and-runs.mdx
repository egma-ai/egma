...
```bash
curl -X POST https://your-egma/v1/runs \
  -H "Authorization: Bearer egma_..." \
  -H "Content-Type: application/json" \
  -d '{
    "connectionId": "con_01K…",
    "testVersionIds": ["tstv_01K…", "tstv_01K…"],
    "idempotencyKey": "release-2026-08-20"
  }'
```
...
<CardGroup cols={2}>
  ...
  <Card title="skipped" icon="circle-minus">
    Nothing was judged. The test required a capability this connection does not have (for example, DTMF tones on a Chat connection), or the grader had nothing scoreable.
  </Card>
