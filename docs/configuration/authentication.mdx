...
- **Management operations** (creating projects and reading members): an organization-wide key works fine. Phone carrier credentials are deployment environment values, not API resources.
...
| **admin** | Everything a member can do, plus: invite and remove members and change roles. |
