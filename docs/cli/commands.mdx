...
<AccordionGroup>
  <Accordion title="egma — interactive wizard">
    Opens the full interactive wizard. It signs you in and discovers your voice agent using your coding agent, then asks the one question it exists to ask: should Egma **test** the agent, **watch its production traffic**, or **both**.
  ...
  <Accordion title="egma monitoring — watch production traffic">
    ...
    **Key flags**
    ...
    belongs to your coding agent: see the `integrate-egma-sdk` skill.
