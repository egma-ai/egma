...
/**
 * Stop pulling this agent's production calls
 */
export const stopPullingProductionCalls = <ThrowOnError extends boolean = false>(parameters: {
    agentId: string;
    projectId?: string;
}, options?: Options<never, ThrowOnError>): RequestResult<StopPullingProductionCallsResponses, StopPullingProductionCallsErrors, ThrowOnError> => {
    const params = buildClientParams([parameters], [{ args: [{ in: 'path', key: 'agentId' }, { in: 'query', key: 'projectId' }] }]);
    return (options?.client ?? client).delete<StopPullingProductionCallsResponses, StopPullingProductionCallsErrors, ThrowOnError>({
        security: [{ scheme: 'bearer', type: 'http' }, {
                in: 'cookie',
                name: 'egma.session_token',
                type: 'apiKey'
            }],
        url: '/v1/agents/{agentId}/production-pull',
        ...options,
        ...params
    });
};
...
/**
 * Pull this agent's production calls
 */
export const startPullingProductionCalls = <ThrowOnError extends boolean = false>(parameters: {
    agentId: string;
    projectId?: string;
    agentPlatform: 'retell';
    platformAgentId: string;
    apiKey: string;
}, options?: Options<never, ThrowOnError>): RequestResult<StartPullingProductionCallsResponses, StartPullingProductionCallsErrors, ThrowOnError> => {
    const params = buildClientParams([parameters], [{ args: [
                { in: 'path', key: 'agentId' },
                { in: 'query', key: 'projectId' },
                { in: 'body', key: 'agentPlatform' },
    ...
    return (options?.client ?? client).put<StartPullingProductionCallsResponses, StartPullingProductionCallsErrors, ThrowOnError>({
        security: [{ scheme: 'bearer', type: 'http' }, {
                in: 'cookie',
                name: 'egma.session_token',
                type: 'apiKey'
