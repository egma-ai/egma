 ...
 * two readers could be settled against. The reducers are on the surface for the
 * same reason as the arithmetic above them: the reduction to the one number a
 * grader uses is part of the answer, not a caller's business.
 *
