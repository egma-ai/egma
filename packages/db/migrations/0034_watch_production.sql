...
--    or before it has been drained by the poller. It is null until watching is
--    switched on, and the switch starts it at that moment, which is what makes
--    watching mean *from here on* rather than *and everything before*.
