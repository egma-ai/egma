...
--
-- The founder approved removing the connection-owned Retell Monitoring state, its
-- webhook state, and all production claims. No older API or rollback contract
-- is supported after this migration. Supported simulation connections are
-- converted to the explicit platform/kind/variant axes in place.
...
-- Add the new simulation axes as nullable columns so existing rows can be
-- translated before the required columns and checks are enforced.
ALTER TABLE "connection" ADD COLUMN "agent_platform" text;
--> statement-breakpoint
ALTER TABLE "connection" ADD COLUMN "connection_kind" text;
--> statement-breakpoint
ALTER TABLE "connection" ADD COLUMN "access_variant" text;
--> statement-breakpoint
...
-- Runs freeze the non-secret connection facts as camelCase JSON. Runtime reads
-- only the new document after this direct cutover, so every surviving legacy
-- snapshot must move with its connection. Read the access variant from the
-- snapshot's own historical config, not from the current connection row: a
-- LiveKit connection may have been edited after this run started.
UPDATE "run"
...
ALTER TABLE "connection" ALTER COLUMN "connection_kind" SET NOT NULL;
--> statement-breakpoint
ALTER TABLE "connection" ALTER COLUMN "access_variant" SET NOT NULL;
--> statement-breakpoint
ALTER TABLE "connection" ADD CONSTRAINT "connection_agent_platform_allowed" CHECK ("connection"."agent_platform" in ('retell', 'livekit_agents'));
--> statement-breakpoint
ALTER TABLE "connection" ADD CONSTRAINT "connection_kind_allowed" CHECK ("connection"."connection_kind" in ('retell_chat_api', 'phone_number', 'livekit_room'));
--> statement-breakpoint
...
ALTER TABLE "connection" DROP CONSTRAINT "connection_type_allowed";
--> statement-breakpoint
ALTER TABLE "connection" DROP COLUMN "type";
--> statement-breakpoint
ALTER TABLE "connection" DROP COLUMN "variant_id";
--> statement-breakpoint
ALTER TABLE "connection" DROP COLUMN "watch_production";
--> statement-breakpoint
ALTER TABLE "connection" DROP COLUMN "production_cursor";
--> statement-breakpoint
ALTER TABLE "connection" DROP COLUMN "webhook_registered_at";
--> statement-breakpoint
ALTER TABLE "connection" DROP COLUMN "webhook_delivered_at";
--> statement-breakpoint
...
ALTER TABLE "monitoring_setup" ADD CONSTRAINT "monitoring_setup_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "monitoring_setup" ADD CONSTRAINT "monitoring_setup_created_by_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "monitoring_setup" ADD CONSTRAINT "monitoring_setup_project_organization_fk" FOREIGN KEY ("project_id","organization_id") REFERENCES "public"."project"("id","organization_id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "retell_monitored_agent" ADD CONSTRAINT "retell_monitored_agent_monitoring_setup_id_monitoring_setup_id_fk" FOREIGN KEY ("monitoring_setup_id") REFERENCES "public"."monitoring_setup"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "retell_monitored_agent" ADD CONSTRAINT "retell_monitored_agent_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "retell_monitored_agent" ADD CONSTRAINT "retell_monitored_agent_project_organization_fk" FOREIGN KEY ("project_id","organization_id") REFERENCES "public"."project"("id","organization_id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "production_trace_claim" ADD CONSTRAINT "production_trace_claim_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "production_trace_claim" ADD CONSTRAINT "production_trace_claim_project_organization_fk" FOREIGN KEY ("project_id","organization_id") REFERENCES "public"."project"("id","organization_id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "retell_ingestion_failure" ADD CONSTRAINT "retell_ingestion_failure_organization_id_organization_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organization"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "retell_ingestion_failure" ADD CONSTRAINT "retell_ingestion_failure_retell_monitored_agent_id_retell_monitored_agent_id_fk" FOREIGN KEY ("retell_monitored_agent_id") REFERENCES "public"."retell_monitored_agent"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "retell_ingestion_failure" ADD CONSTRAINT "retell_ingestion_failure_project_organization_fk" FOREIGN KEY ("project_id","organization_id") REFERENCES "public"."project"("id","organization_id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint

CREATE INDEX "monitoring_setup_project_idx" ON "monitoring_setup" USING btree ("project_id");
--> statement-breakpoint
CREATE INDEX "retell_monitored_agent_due_idx" ON "retell_monitored_agent" USING btree ("next_poll_at","lease_expires_at");
--> statement-breakpoint
CREATE INDEX "retell_monitored_agent_project_idx" ON "retell_monitored_agent" USING btree ("project_id");
--> statement-breakpoint
CREATE INDEX "production_trace_claim_unwritten_idx" ON "production_trace_claim" USING btree ("claimed_at") WHERE "production_trace_claim"."status" = 'claimed';
--> statement-breakpoint
CREATE INDEX "retell_ingestion_failure_open_idx" ON "retell_ingestion_failure" USING btree ("retell_monitored_agent_id","last_attempt_at") WHERE "retell_ingestion_failure"."status" = 'open';
