...
-- The prior build cannot write simulation rows after this migration.
...
ALTER TABLE "simulation" ADD CONSTRAINT "simulation_report_only_when_ended" CHECK ("simulation"."ended_at" is not null
        or "simulation"."recording_reference" is null);--> statement-breakpoint
ALTER TABLE "simulation" ADD CONSTRAINT "simulation_audio_facts_are_voice_facts" CHECK ("simulation"."modality" = 'voice'
