...
- `unsupported-capability` — Stop before unsupported remote setup, preserve any completed requested capability, and report the missing capability without claiming that the full outcome completed.
