...
export function helpText(): string {
  return [
    ...
    "  passed, failed, skipped, errored, plus pending and simulations. Last, one",
    "  wrote: line per file it wrote into egma/runs/<run-id>/ — the platform's",
    "  own account of the run, the results a line each, and a summary to read.",
    "  Those files are committed like the tests are: the evidence a change works",
    "  belongs in the same pull request as the change.",
    "",
