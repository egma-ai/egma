...
const HELP: Readonly<Record<HelpTopic, readonly string[]>> = {
  ...
  "persona use": ["Usage:", "  egma persona use <Persona ID> --stt-provider <id> --stt-model <id> --tts-provider <id> --tts-model <id> --llm-provider <id> --llm-model <id> --voice <id>", "  [--language <tag>] [--emotion <value>] [--accent <value>] [--speed <number>] [--speech-volume <number>] [--voice-access-proof <proof>] [--cwd <path>]", "", "Save this Project's first settings for a predefined persona."],
  "persona create": ["Usage:", "  egma persona create --name <name> [--description <text>] --identity-name <name> --personality <text>", "  --stt-provider <id> --stt-model <id> --tts-provider <id> --tts-model <id> --llm-provider <id> --llm-model <id> --voice <id>", "  [--language <tag>] [--emotion <value>] [--accent <value>] [--speed <number>] [--speech-volume <number>] [--voice-access-proof <proof>] [--cwd <path>]", "", "Create an independent custom persona. Use capabilities first to choose valid settings."],
  ...
  "persona update": ["Usage:", "  egma persona update <Persona ID> [--name <name>] [--description <text>] [--identity-name <name>] [--personality <text>] [--expected-version <id>]", "  --stt-provider <id> --stt-model <id> --tts-provider <id> --tts-model <id> --llm-provider <id> --llm-model <id> --voice <id>", "  [--language <tag>] [--emotion <value>] [--accent <value>] [--speed <number>] [--speech-volume <number>] [--voice-access-proof <proof>] [--cwd <path>]", "", "Update project settings. Behavior changes also need --expected-version."],
  "persona preview": ["Usage:", "  egma persona preview --stt-provider <id> --stt-model <id> --tts-provider <id> --tts-model <id> --llm-provider <id> --llm-model <id> --voice <id>", "  [--language <tag>] [--emotion <value>] [--accent <value>] [--speed <number>] [--speech-volume <number>] [--voice-access-proof <proof>] [--cwd <path>]", "", "Print a short base64 audio preview response. Interruptions require a full simulation."],
  "suite create": [
    "Usage:",
    "  egma suite create <directory> --name <name> [--cwd <path>]",
    "",
