...
export function helpText(): string {
  return [
    ...
    "  egma self-host setup            Configure that platform: the persona's",
    "                                  model, what it speaks and hears with,",
    "                                  and the carrier a phone call goes over.",
    "                                  It asks only for what the platform does",
    "                                  not already hold and writes every answer",
    "                                  through the platform's own API. For the",
    "                                  carrier it asks for a Twilio account, a",
    "                                  number it already owns and its Auth",
    "                                  Token, and shows a plan before it writes",
    "                                  anything there. It never buys a number.",
    ...
    "  when there is something to do about it by hand. init adds a platform:",
    "  line whenever this repository is bound, whether this run bound it or",
    "  found it already bound.",
    "",
