...
const HELP: Readonly<Record<HelpTopic, readonly string[]>> = {
  ...
  "persona use": ["Usage:", "  egma persona use <Persona ID> [--stt-provider <id>] [--stt-model <id>] [--tts-provider <id>] [--tts-model <id>]", "  [--llm-provider <id>] [--llm-model <id>] [--voice <id>] [--language <tag>] [--emotion <value>] [--accent <value>]", "  [--speed <number>] [--speech-volume <number>] [--voice-access-proof <proof>] [--cwd <path>]", "", "Save this Project's first settings for a predefined persona.", "With no settings, use the persona's built-in defaults. Run persona capabilities before overriding them."],
  ...
  "persona update": ["Usage:", "  egma persona update <Persona ID> [--name <name>] [--description <text>] [--identity-name <name>] [--personality <text>] [--expected-version <id>]", "  [--stt-provider <id>] [--stt-model <id>] [--tts-provider <id>] [--tts-model <id>] [--llm-provider <id>] [--llm-model <id>] [--voice <id>]", "  [--language <tag>] [--emotion <value>] [--accent <value>] [--speed <number>] [--speech-volume <number>] [--voice-access-proof <proof>] [--cwd <path>]", "", "Update only the supplied fields. Behavior changes also need --expected-version."],
