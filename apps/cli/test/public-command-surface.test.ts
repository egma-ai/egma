...
const APPROVED_FLAGS = [
  ...
  { words: ["persona", "use"], flags: ["--accent", "--cwd", "--emotion", "--language", "--llm-model", "--llm-provider", "--speech-volume", "--speed", "--stt-model", "--stt-provider", "--tts-model", "--tts-provider", "--voice", "--voice-access-proof"] },
  { words: ["persona", "create"], flags: ["--accent", "--cwd", "--description", "--emotion", "--identity-name", "--language", "--llm-model", "--llm-provider", "--name", "--personality", "--speech-volume", "--speed", "--stt-model", "--stt-provider", "--tts-model", "--tts-provider", "--voice", "--voice-access-proof"] },
  { words: ["persona", "update"], flags: ["--accent", "--cwd", "--description", "--emotion", "--expected-version", "--identity-name", "--language", "--llm-model", "--llm-provider", "--name", "--personality", "--speech-volume", "--speed", "--stt-model", "--stt-provider", "--tts-model", "--tts-provider", "--voice", "--voice-access-proof"] },
  { words: ["persona", "preview"], flags: ["--accent", "--cwd", "--emotion", "--language", "--llm-model", "--llm-provider", "--speech-volume", "--speed", "--stt-model", "--stt-provider", "--tts-model", "--tts-provider", "--voice", "--voice-access-proof"] },
