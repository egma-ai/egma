...
const APPROVED_FLAGS = [
  ...
  { words: ["persona", "use"], flags: ["--accent", "--background-sound", "--background-volume", "--cwd", "--emotion", "--language", "--llm-model", "--llm-provider", "--speech-volume", "--speed", "--stt-model", "--stt-provider", "--tts-model", "--tts-provider", "--voice", "--voice-access-proof"] },
  { words: ["persona", "create"], flags: ["--accent", "--background-sound", "--background-volume", "--cwd", "--description", "--emotion", "--identity-name", "--language", "--llm-model", "--llm-provider", "--name", "--personality", "--speech-volume", "--speed", "--stt-model", "--stt-provider", "--tts-model", "--tts-provider", "--voice", "--voice-access-proof"] },
  { words: ["persona", "update"], flags: ["--accent", "--background-sound", "--background-volume", "--cwd", "--description", "--emotion", "--expected-version", "--identity-name", "--language", "--llm-model", "--llm-provider", "--name", "--personality", "--speech-volume", "--speed", "--stt-model", "--stt-provider", "--tts-model", "--tts-provider", "--voice", "--voice-access-proof"] },
  { words: ["persona", "preview"], flags: ["--accent", "--background-sound", "--background-volume", "--cwd", "--emotion", "--language", "--llm-model", "--llm-provider", "--speech-volume", "--speed", "--stt-model", "--stt-provider", "--tts-model", "--tts-provider", "--voice", "--voice-access-proof"] },
